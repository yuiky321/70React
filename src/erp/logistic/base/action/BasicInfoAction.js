...
export const searchWorkplaceList =() => ({type:"src/erp/logistic/Saga/SEARCH_WORKPLACE_LIST" });
/*
결과 : {
    type:'src/erp/logistic/Saga/SEARCH_WORKPLACE_LIST'
    
}

*/
export const updateWorkplace = createAction(types.UPDATE_WORKPLACE_LIST);
